...
| `_nw_data_transfer_report_all_paths` | const | `connection_report.h` | The crate does not expose data-transfer report collection/filtering. |
| `nw_connection_access_establishment_report` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_connection_create_new_data_transfer_report` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_collect` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_copy_path_interface` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_duration_milliseconds` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_path_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_path_radio_type` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_received_application_byte_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_received_ip_packet_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_received_transport_byte_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_received_transport_duplicate_byte_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_received_transport_out_of_order_byte_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_sent_application_byte_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_sent_ip_packet_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_sent_transport_byte_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_sent_transport_retransmitted_byte_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_state` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_transport_minimum_rtt_milliseconds` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_transport_rtt_variance` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_get_transport_smoothed_rtt_milliseconds` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_state_t` | enum | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_data_transfer_report_t` | type | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_copy_proxy_endpoint` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_enumerate_protocols` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_enumerate_resolution_reports` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_enumerate_resolutions` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_get_attempt_started_after_milliseconds` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_get_duration_milliseconds` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_get_previous_attempt_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_get_proxy_configured` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_get_used_proxy` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_establishment_report_t` | type | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_report_resolution_protocol_t` | enum | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_report_resolution_source_t` | enum | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_resolution_report_copy_preferred_endpoint` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_resolution_report_copy_successful_endpoint` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_resolution_report_get_endpoint_count` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_resolution_report_get_milliseconds` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_resolution_report_get_protocol` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_resolution_report_get_source` | function | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
| `nw_resolution_report_t` | type | `connection_report.h` | Connection establishment/data-transfer reporting APIs are not wrapped. |
...
| `nw_endpoint_copy_txt_record` | function | `endpoint.h` | Core endpoint constructors/accessors are wrapped; address/TXT-record raw access is not. |
| `nw_endpoint_get_address` | function | `endpoint.h` | Core endpoint constructors/accessors are wrapped; address/TXT-record raw access is not. |
...
| `nw_ethernet_channel_cancel` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_create` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_create_with_parameters` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_get_maximum_payload_size` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_send` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_set_queue` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_set_receive_handler` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_set_state_changed_handler` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_start` | function | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
| `nw_ethernet_channel_t` | type | `ethernet_channel.h` | Ethernet channel APIs are not wrapped. |
...
| `nw_interface_radio_type_t` | enum | `interface.h` | Basic interface enumeration is wrapped; radio-type details are not. |
...
| `nw_multipath_service_t` | enum | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_clear_prohibited_interface_types` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_clear_prohibited_interfaces` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_copy_local_endpoint` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_copy_required_interface` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
...
| `nw_parameters_create_quic` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_expired_dns_behavior_t` | enum | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_get_expired_dns_behavior` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_get_fast_open_enabled` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_get_include_peer_to_peer` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_get_local_only` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_get_multipath_service` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_get_prefer_no_proxy` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_get_reuse_local_address` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_get_service_class` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_iterate_prohibited_interface_types` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_iterate_prohibited_interfaces` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_prohibit_interface` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_prohibit_interface_type` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_require_interface` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_requires_dnssec_validation` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_expired_dns_behavior` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_fast_open_enabled` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_include_peer_to_peer` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_local_endpoint` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_local_only` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_multipath_service` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_requires_dnssec_validation` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_reuse_local_address` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_parameters_set_service_class` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_protocol_stack_clear_application_protocols` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_protocol_stack_copy_transport_protocol` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_protocol_stack_iterate_application_protocols` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_protocol_stack_set_transport_protocol` | function | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
| `nw_service_class_t` | enum | `parameters.h` | Common parameter builders are wrapped; many policy, endpoint, multipath, and service-class knobs remain uncovered. |
...
| `nw_protocol_metadata_is_quic` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_copy_sec_protocol_metadata` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_copy_sec_protocol_options` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_application_error` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_application_error_reason` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_initial_max_stream_data_bidirectional_local` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_initial_max_stream_data_bidirectional_remote` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_initial_max_stream_data_unidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_initial_max_streams_bidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_initial_max_streams_unidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_keepalive_interval` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_local_max_streams_bidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_local_max_streams_unidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_max_datagram_frame_size` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_remote_idle_timeout` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_remote_max_streams_bidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_remote_max_streams_unidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_stream_application_error` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_stream_id` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_stream_type` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_get_stream_usable_datagram_frame_size` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_application_error` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_initial_max_stream_data_bidirectional_local` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_initial_max_stream_data_bidirectional_remote` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_initial_max_stream_data_unidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_initial_max_streams_bidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_initial_max_streams_unidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_keepalive_interval` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_local_max_streams_bidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_local_max_streams_unidirectional` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_max_datagram_frame_size` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_set_stream_application_error` | function | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
| `nw_quic_stream_type_t` | enum | `quic_options.h` | QUIC connection/options cover a useful subset, but stream/metadata and many transport tunables are missing. |
...
| `nw_txt_record_access_bytes` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_access_key` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_apply` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_copy` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_create_dictionary` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_create_with_bytes` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_find_key` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_find_key_t` | enum | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_get_key_count` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_is_dictionary` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_is_equal` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_remove_key` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_set_key` | function | `txt_record.h` | TXT-record helper APIs are not wrapped. |
| `nw_txt_record_t` | type | `txt_record.h` | TXT-record helper APIs are not wrapped. |
...
| --- | --- | --- | --- | --- |
| _None_ | - | - | No macOS-deprecated public Network.framework symbols were found in MacOSX26.2.sdk. | - |
